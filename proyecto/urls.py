...
urlpatterns = [
    ...
    path('<int:id_proyecto>/backlog/ver_tipoUS', views.VerTiposdeUSView.as_view(), name='ver_tipoUS'),
    path('<int:id_proyecto>/backlog/crear_tipoUS', views.CrearTiposUSView.as_view(), name='crear_tipoUS'),
    ...
    path('<int:id_proyecto>/backlog/ver_product_backlog', views.verProductBacklog.as_view(), name='ver_product_backlog'),
