...
urlpatterns = [
    ...
    path('<int:id_proyecto>/equipo/<int:id_equipo>/cambiar_scrum/', views.CambiarScrumMasterView.as_view(), name='cambiar_scrum'),
    ...
    path('<int:id_proyecto>/sprint/<int:id_sprint>/cancelar/', views.CancelarSprint.as_view(), name='cancelar_sprint'),
    path('<int:id_proyecto>/sprint/<int:id_sprint>/burndown/', views.BurndownChartView.as_view(), name='ver_burndown'),
